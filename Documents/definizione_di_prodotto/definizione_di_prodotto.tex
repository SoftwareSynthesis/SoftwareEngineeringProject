...
La descrizione di ciascuna vista riportata nel presente documento comprende, oltre alla funzione e ai metodi che essa mette a disposizione del relativo \inglese{presenter}, anche la struttura degli elementi che la compongono.
...
\subsubsection*{Metodi}
\begin{description}
  \item{\method{-- createContactList(group: Object): void}}\\
  
  \item{\method{-- addListItem(group: Object): void}}\\
  
  \item{\method{+ createAddToGroupForm(): void}}\\
