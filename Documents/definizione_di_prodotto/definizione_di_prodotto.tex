...
\begin{description}
  ...
  \item{\method{+ processPassword(string: String): void}}\\
  Tale metodo ha il compito di processare il contenuto del campo di immissione per la password, calcolarne la complessità invocando il metodo \method{calculateScore} offerto dal \inglese{presenter} su ognuno dei caratteri del valore del campo di immissione per la \inglese{pasword}, quindi visualizzare un messaggio corrispondente nell'interfaccia grafica.
