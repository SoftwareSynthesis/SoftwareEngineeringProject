...
\begin{verbatim}
"operation=insertInGroup&contactId=" + contact.id + "&groupId=" + group.id
\end{verbatim}
...
% Qui dovrà andarci CONTACTPRESENTER
...
confirm("Sei sicuro di voler eliminare il gruppo" + group.name + "?");
    \end{verbatim}
    e, in caso di risposta affermativa, dovrà essere sollevato un evento con nome identificativo uguale a \verb'groupRemoved' cui risponderà il \inglese{presenter} incaricato di inviare al server la richiesta corrispondente.
  \end{itemize}
