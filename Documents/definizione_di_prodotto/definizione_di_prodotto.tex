...
\subsubsection*{Funzione}
\textit{Controller} richiamata dal \textit{client} per eseguire l'eliminazione di un contatto presente nella propria rubrica.
...
\subsubsection*{Funzione}
\inglese{Controller} richiamata dal \textit{client} per creare un nuovo gruppo nella propria rubrica.
