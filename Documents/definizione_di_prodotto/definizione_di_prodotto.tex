...
\subsubsection*{Funzione}
Vista associata al \inglese{presenter} \classname{RegisterPresenter} utilizzata per effettuare la registrazione al sistema.
...
\subsubsection*{Funzione}
Vista associata al \inglese{presenter} \classname{CallHistoryPresenter} utilizzata per la visualizzazione dello storico chiamate.
