...
Tale metodo ha il compito, dato un utente, di verificare se è già presente nella rubrica. Metodo di utilità richiamato ad esempio dai .metodi \method{addContact()} e \method{removeContact()}. In caso il contatto venga trovato, il metodo restituisce true, altrimenti false.
...
\subsubsection*{Metodi}
\begin{description}
\item{\method{- createLabel(contact: Object(contact)): String}}\\
...
%TODO da sistemare perchè diego deve modificare chat
\item{\method{- createChatItem(chat: Object()): DOM\_node}}\\
	Tale metodo restituisce un DOM\_element di tipo <li> contenente l'identificativo dell'utente con cui si sta comunicando (parametro del metodo).

%TODO da sistemare perchè diego deve modificare chat	
\item{\method{- createChatElement(chat: Object()): DOM\_node}}\\
	Tale metodo restituisce un DOM\_element di tipo <li> contenente l'identificativo dell'utente con cui si sta comunicando (parametro del metodo).

%TODO da sistemare perchè diego deve modificare chat	
\item{\method{+ addChat(chat: Object()): void}}\\
	
%TODO da sistemare perchè diego deve modificare chat	
\item{\method{+ removeChat(chat: Object()): void}}\\
...
\begin{itemize}
\item div relativo alla chiamata assegnandogli un id;
\item div relativo alla chat testuale assegnandogli un id;
\item elemento video per la visualizzazione del proprio stream ricavato dalla videocamera;
\item elemento video per la visualizzazione dello stream dell'altro utente;
\item div dove inserire la visualizzazione delle statistiche della chiamata;
\item bottone per la terminazione della chiamata.
...
\item pulsante per sbloccare il contatto.
\end{itemize}
Successivamente si andranno a popolare tali elementi utilizzando le informazioni del contatto passato come parametro (contact). Infine si imposterà correttamente il comportamento dei bottoni associando le giuste chiamate a metodi.
...
\item{\method{+ displayContact(object(contact)): void}}\\
...
\item{\method{+ contactAlreadyPresent(object(contact)): boolean}}\\
...
%TODO controllare che non siano stati aggiunti metodi
