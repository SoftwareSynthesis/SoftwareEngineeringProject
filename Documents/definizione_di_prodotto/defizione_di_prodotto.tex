...
\item{\method{- adjustBlockButtonDisplay(contact: Object(contact)): void}}\\
	Il metodo riceve come parametro un contatto (contact). Successivamente viene controllato se tale utente è bloccato o meno e imposta correttamente la visualizzazione della vista.
