...
\begin{itemize}
	...
	\item \classname{org.softwaresynthesis.mytalk.server.dao.UserDataDAO}:
\end{itemize}

\subsubsection*{Attributi}

\begin{itemize}
	\item{\underline{\memberdata{-- \{frozen\} serialVersionUID: long}}}
...
\begin{description}
	...
	\item{\method{+ diGet(request HttpServletRequest, response HttpServletResponse): void}}\\
