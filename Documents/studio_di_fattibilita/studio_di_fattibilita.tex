...
\begin{itemize}
	...
	\item di base, vi è un \underline{server} scritto in \underline{java} con l'implementazione di \underline{webSocket}, al quale i client dovranno connettersi, ma che non dovrà partecipare alla comunicazione tra gli utenti;
...
\begin{description}
	...
	\item{\scshape\bfseries Vantaggi d'implementazione:} l'utilizzo di \underline{JSP} come linguaggio di scripting è fortemente consigliato per avere un accesso diretto alle funzionalità proposte dal server java.
