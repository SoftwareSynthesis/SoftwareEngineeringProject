...
\newcommand{\docAuthors}{Andrea Rizzi\\ &Riccardo Tresoldi\\&Marco Schivo}
% Approvato da
\newcommand{\approvedBy}{Andrea Meneghinello}
% Verificatori
\newcommand{\verifiedBy}{Elena Zecchinato}
...
\begin{description}
	...
	\item{\scshape\bfseries Vantaggi d'implementazione:} l'applicativo renderebbe quasi nullo il \underline{TCO}. Esso funzionerebbe solo con l'apposita installazione del browser Google Chrome, e non richiedere l'installazione di componenti aggiuntivi o \inglese{plugin}.
...
Il progetto proposto dall'azienda \inglese{Mentis} riguarda la creazione di un software per la conversione 3D. Nello specifico, il software deve:
\begin{itemize}
	...
	\item Step 2: incorporare un sistema di ottimizzazione che comprenda tra le specifiche: l'anteprima delle modifiche, l'anteprima della rotazione, la modifica delle caratteristiche fondamentali, l'importazione del formato \inglese{Wavefront} .OBJ, la trasparenza dell'oggetto, la lettura dei file .JSON, la gestione di animazioni, e l'esportazione dell'oggetto.
\end{itemize}
