...
\item \textit{testToString() } verifica il metodo \textit{toString} che opera la conversione in stringa degli oggetti della classe.
\end{itemize}
...
\item \textit{testEqual() }
\item \textit{testToString() }
\end{itemize}
\textbf{Risultato del test:} non sono stati rilevati errori.
