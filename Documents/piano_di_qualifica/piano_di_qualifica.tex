...
\subsubsection{Autovalutazione dei ruoli fino RQ}
\begin{itemize}
...
\subsubsection{Package \texttt{org.softwaresinthesis.mytalk.server.autentication}}
\begin{itemize}
\item \textbf{AESAlgorithmTest}\\
...
\item \textbf{AuthenticationDataTest}\\
...
\item \textbf{AuthenticationModuleTest}\\
...
\item \textbf{CredentialLoaderTest}\\
...
\textbf{Risultato del test:} superato con successo.
\end{itemize}
\subsubsection{Package \texttt{org.softwaresinthesis.mytalk.server.authentication.servlet}}
\begin{itemize}
\item \textbf{LoginServletTest}\\
...
\item \textbf{RegisterServletTest}\\
...
\item \textbf{AdressBookEntryTest}\\
...
\subsubsection{Package \texttt{org.softwaresinthesis.mytalk.server.abook.servlet}}
\begin{itemize}
\item \textbf{AddressBookDoAddContactServletTest}\\
...
\item \textbf{AddressBookDoRemoveContactServletTest}\\
...
\item \textbf{AddressBookDoCreateGroupServletTest}\\
...
\item \textbf{AddressBookDoDeleteGroupServletTest}\\
...
\item \textbf{AddressBookDoInsertInGroupServletTest}\\
...
\item \textbf{AddressBookDoRemoveFromGroupServletTest}\\
...
\item \textbf{AddressBookDoBlockServletTest}\\
...
\item \textbf{AddressBookDoUnblockServletTest}\\
...
\item \textbf{AddressBookDoSearchServletTest}\\
...
\item \textbf{AddressBookGetContactsServletTest}\\
...
\item \textbf{AddressBookGetGroupsServletTest}\\
...
\item \textbf{AddressBookEntryDAOTest}\\
...
\subsubsection{Package \texttt{org.softwaresynthesis.mytalk.clientpreenter.guicontrol}}

\begin{itemize}
\item \textbf{AccountSettingsPanelPresenterTest}\\
...
\item \textbf{AddressBookPanelPresenterTest}\\
...
\item \textbf{CallHistoryPanelPresenterTest}\\
...
\item \textbf{CommunicationPanelPresenterTest}\\
...
\item \textbf{ContactPanelPresenterTest}\\
...
\item \textbf{GroupPanelPresenterTest}\\
...
\item \textbf{LoginPanelPresenterTest}\\
...
\item \textbf{MainPanelPresenterTest}\\
...
\item \textbf{MessagePanelPresenterTest}\\
...
\item \textbf{RegisterPanelPresenterTest}\\
...
\item \textbf{SearchResultPanelPresenterTest}\\
...
\item \textbf{ToolsPanelPresenterTest}\\
