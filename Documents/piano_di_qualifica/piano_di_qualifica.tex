...
\item \texttt{testDestroy() } controlla che venga correttamente rimosso il \inglese{form} di registrazione.
...
\item \texttt{testDestroy()} controlla che venga correttamente eliminato il \inglese{form} degli strumenti.
