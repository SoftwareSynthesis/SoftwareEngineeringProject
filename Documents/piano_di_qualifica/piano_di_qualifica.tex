...
1.5 & Aggiornamento capitolo ``Prossima versione piano di qualifica'' e riscritta sezione ``software''& & & 2013-01-16\\
1.4 & Creazione e organizzazione capitolo ``Appendice'' e sezioni interne & & & 2013-01-15\\
1.3 & Correzione capitolo riguardante ``Misure, Metriche e metodi'' & & & 2013-01-15\\
1.3 & Stesura capitolo ``Resoconto esito delle revisioni'' e sezioni interne & & & 2013-01-14\\
1.2 & Correzione capitolo ``Visione generale strategia di verifica'' modificando strutturalmente la parte relativa a ``Organizzazione, pianificazione strategica, pianificazione temporale e responsabilità''& & & 2013-01-14\\
1.1 & Stesura sezione ``qualità di processo'' & & & 2013-01-13\\
...
\item \textbf{Fase di collaudo:} confrontare che quanto sarà prodotto sia coerente con le specifiche del committente, analizzando eventuali problemi che possono emergere e non sono stati considerati nella fasse di progettazione.
