...
\item \texttt{testDoPost()} verifica il comportamento della \inglese{servlet} nel momento in cui viene invocato il metodo \texttt{doPost}. In particoalare, si verifica che sia invocato il parametro \texttt{operation} dalla richiesta HTTP, e che sia invocato correttamente il metodo \texttt{execute} sul \texttt{controller} associato all'operazione passando a quest'ultimo la richiesta e la risposta con cui è invocato il metodo da testare. 
...
\begin{itemize}
\item \textbf{TM2.01: AESAlgorithmTest}\\
...
\item \textbf{TM2.02: AuthenticationModuleTest}\\
...
\item \textbf{TM2.03: CredentialLoaderTest}\\
...
Controlla la possibilità di recuperare la \inglese{password} da parte di un utente regolarmente registrato al sistema e che fornisce pertanto uno \inglese{username} valido.

\item \texttt{testRecoverPasswordUnsuccesfully()} 
verifica la possibilità di recuperare la \inglese{password} da parte di un utente che fornisce uno \inglese{username} non presente nel \inglese{database}.
...
\item \textbf{TM4.02: DeleteContactControllerTest}\\
...
\item \textbf{TM4.03: CreateGroupControllerTest}\\
...
\item \textbf{TM4.04: DeleteGroupControllerTest}\\
...
\item \textbf{TM4.06: DeleteFromGroupControllertTest}\\
...
\item \textbf{TM4.07: BlockContactControllerTest}\\
...
\item \textbf{TM4.08: UnblockControllerTest}\\
\textbf{Verifica l'oggetto:} \textit{UnblockController}.\\
...
\item \textbf{TM4.09: SearchControllerTest}\\
...
I possibili input riguardano dati passati mediante \texttt{XMLHttpRequest}, che possono essere corretti (campi dati non vuoti) o non (campi dati vuoti). %TODO: VERIFICARE
Tale test si compone di due metodi:
\begin{itemize}
...
\item \textbf{TM4.10: GetContactsControllerTest}\\
...
\item \textbf{TM4.11: GetGroupsControllerTest}\\
...
\item textbf{TM5.12: GetMessagesControllerTest}
...
\item \textbf{TM5.05: AddMessageControllerTest} 
...
\item \textbf{TM5.05: DeleteMessageControllerTest} 
...
\item \textbf{TM5.05: UpdateMessageControllerTest} 
...
\item \texttt{testUpdateNotOwnedMessage()} %TODO: da descrivere

\end{itemize} 
\textbf{Risultato del test:} superato con successo.

\item \textbf{TM5.05: GetUtilTest} 
...
TM1.04 & NameLoaderTest &Superato\\
TM1.04 & PasswordLoaderTest &Superato\\
...
TM4.01 & AddContactControllerTest &Superato\\
TM4.02 & RemoveContactControllerTest &Superato\\
TM4.03 & CreateGroupControllerTest &Superato\\
TM4.04 & DeleteGroupControllerTest &Superato\\
TM4.05 & InsertInGroupControllerTest &Superato\\
TM4.06 & RemoveFromGroupControllerTest &Superato\\
TM4.07 & BlockControllerTest &Superato\\
TM4.08 & UnblockControllerTest &Superato\\
TM4.09 & SearchControllerTest &Superato\\
TM4.10 & GetContactsControllerTest &Superato\\
TM4.11 & GetGroupsControllerTest &Superato\\
