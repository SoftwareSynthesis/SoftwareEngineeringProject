...
\subsection{Metodi}
Pag 18 par.3.3.3 zetasoluction

\subsection{Metriche (per il codice!)}\label{sec:metrics}
...
\item{\textbf{analisi del flusso di informazione}} al fine di assicurare l'assenza di dipendenze fra valori di variabili incoerenti con quanto previsto in fase di progettazione architetturale (a livello di modulo, di componente o di sistema nella sua totalità).
\end{description}
\clearpage
