...
\textbf{Verifica il requisito:} RSQO27.0.0, il modello SPY e CMMI sono utilizzati per valutare la qualità dei processi\\
...
\textbf{Verifica il requisito:} RSQO28.0.0, gli standard di qualità hanno come riferimento lo standard ISO/9126:2001.\\
...
\textbf{Verifica il requisito:} RSQO28.1.0, adozione del ciclo di Deming (PDCA) per valutare Interno e migliorare i processi.\\
...
\textbf{Verifica il requisito:} RSQO29.0.0, distinte modalità di verifica per ogni attività durante Interno il ciclo di vita progettuale.\\
...
\textbf{Verifica il requisito:} RSQO30.0.0, uso di un sistema di \textit{ticketing} (tracciato) per Interno evidenziare e risolvere errori o problematiche.\\
...
\textbf{Verifica il requisito:} RSQO31.0.0, l'attività di progettazione condotta nel rispetto dei principi della programmazione ad oggetti.\\
...
\textbf{Verifica il requisito:} RSQO31.1.0, durante la progettazione è imposto l'utilizzo di interfacce.\\
...
\textbf{Verifica il requisito:} RSQO31.2.0, il processo di individuazione delle classi e il loro corrispettivo inserimento in una componente è giustificato dal significato e dall'utilizzo della classe stessa(principio di coesione).\\
...
\item \textbf{TSQF24.3.0}\\
\textbf{Verifica il requisito:} RSQF24.3.0, l'applicativo funziona all'interno di altri browser del S.O. GNU/Linux, in particolare, Chromium con una versione $\geq 25.0.1313$.\\
\textbf{Descrizione:} il superamento di tale requisito è stato determinato eseguendo l'applicativo all'interno del browser e constatando che tutte le funzionalità disponibili nel browser Chrome siano ugualmente disponibili e funzionanti.\\
\textbf{Risultato del test:} superato con successo.
...
\begin{center}
\rowcolors{2}{lightblue}{llightblue}\begin{longtable}{p{.15\textwidth}p{.75\textwidth}}
