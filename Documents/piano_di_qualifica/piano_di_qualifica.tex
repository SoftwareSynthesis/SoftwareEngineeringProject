...
\end{itemize}
	\item{\scshape\bfseries Progettazione:} Il \underline{processo} di verifica garantirà la rintracciabilità nei componenti individuati durante la fase di Progettazione di ogni singolo requisito descritto nell'Analisi dei Requisiti.
...
\subsection{Procedure di controllo di qualità di \underline{processo}}
La qualità del \underline{processo} è basata su un ciclo continuo di miglioramento basato del \underline{processo} stesso e sull'uso ottimale delle risorse disponibili. 
