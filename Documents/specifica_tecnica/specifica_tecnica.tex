...
\end{center}
	...
	\item{\scshape\bfseries AddressBooks}: è l'entità le cui istanze rappresentano gli utenti nella nella appartenenti alla rubrica di un utente. AddressBooks è caratterizzata dai seguenti attributi:
...
\begin{description}
	...
	\item{\scshape\bfseries UserData - AddressBooks (molti a uno): tale associazione rappresenta il legame che intercorre tra un utente e la rubrica. Tale associazione è di tipo molti a uno, con totalità parziale da AddressBooks a UserData mentre è totale da UserData a AddressBook.
	
	\item{\scshape\bfseries AddressBooks - UserData (uno a uno)}: Tale associazione rappresenta il proprietario di una rubrica. Tale associazione è del tipo uno 
