...
È quindi fornita un'implementazione della \inglese{factory} specifica per JavaDB, mediante la quale è possibile ottenere le classi DAO in cui le implementazioni delle operazioni di inserimento, modifica e cancellazione sono specifiche per tale DBMS\@.
