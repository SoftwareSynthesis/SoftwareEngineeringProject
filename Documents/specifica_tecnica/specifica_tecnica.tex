...
\section{Architettura mytalk.server}\label{sec:server}
...
\section{Architettura mytalk.clientpresenter}\label{sec:clientpresenter}
...
\section{Architettura mytalk.clientview}\label{sec:clientview}
