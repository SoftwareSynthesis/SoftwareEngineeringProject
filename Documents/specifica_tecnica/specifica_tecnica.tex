...
Il comportamento del server in risposta ai messaggi ricevuti dal client è determinato dall'implementazione (\inglese{overriding}) che tale classe fornisce del metodo \texttt{void onTextMessage(CharBuffer)}.
