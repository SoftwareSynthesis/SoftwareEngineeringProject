...
\begin{description}
	\item{\scshape\bfseries Descrizione:} \\
Interfaccia di un messaggio audio della segreteria telefonica che viene implementata dalle classi \texttt{dao.AudioMessage} e \texttt{message.AudioMessageProxy}.
	\item{\scshape\bfseries Componenti che ne fanno uso:}\\
\end{description}
...
\subsubsection{mytalk.server.dao.AudioVideoMessage}
\begin{description}
	\item{\scshape\bfseries Descrizione:} 
	\item{\scshape\bfseries Componenti che ne fanno uso:} 
\end{description}
...
% gestione segreteria lato client
\subsubsection{Gestione segreteria}
\begin{description}
  \item{\bfseries\scshape Descrizione:}\\
Questo componente permette di gestire la segreteria telefonica lato client tramite le classi \texttt{message.AudioMessageProxy} e \texttt{AudioVideoMessageProxy}, che rappresentano dei proxy rispettivamente per \texttt{server.dao.AudioMessage} e \texttt{server.dao.AudioVideoMessage}. In tal modo è possibile che i messaggi vengano scaricati solo quando effettivamente richiesto, in maniera totalmente trasparente per i client della classe.

  \item{\bfseries\scshape Diagramma delle classi:}\\

  \item{\bfseries\scshape Classi utilizzate:}\\
\begin{itemize}
  \item \texttt{message.AudioMessageProxy}
  \item \texttt{message.AudioVideoMessageProxy}
  \item \texttt{server.dao.IAudioMessage}
  \item \texttt{server.dao.IAudioVideoMessage}
\end{itemize}
\end{description}
\subsubsection{Gestione rubrica}
\begin{description}
