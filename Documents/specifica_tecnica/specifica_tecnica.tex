...
\begin{description}
  \item{\scshape\bfseries Descrizione:}\\
Tale classe interagisce con il \inglese{framework} Hibernate e contiene la logica per la manipolazione dei dati (in lettura e scrittura) nella tabella \textit{Calls} del database.
...
\begin{description}
  \item{\scshape\bfseries Descrizione:}\\
  Tale classe interagisce con il \inglese{framework} Hibernate e contiene la logica per la manipolazione dei dati (in lettura e scrittura) nella tabella \textit{CallLists} del database che mappa la relazione molti a molti tra \textit{UserData} e \textit{Calls}.
