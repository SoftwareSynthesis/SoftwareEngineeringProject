...
Anche la classe \texttt{dao.uti.GetUtil} implementa lo stesso comportamento, lasciando alle classi figlie (\texttt{dao.uti.GetCallUtil}, \texttt{dao.uti.GetGroupUtil}, \texttt{dao.uti.GetUserDataUtil}, \texttt{dao.uti.NotInitialize}) il compito di definire l'algoritmo d'implementazione.
