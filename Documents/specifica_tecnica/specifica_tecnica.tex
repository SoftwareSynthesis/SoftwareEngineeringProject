...
\midrule
2.6 & Approvato documento & Marco Schivo & Responsabile & 2013-04-17\\
2.5 & Verifica documento & Stefano Farronato & Verificatore & 2013-04-17\\
2.4 & Corretti riferimenti obsoleti alle classi del package server.dao. Aggiornati i tracciamenti & Diego Beraldin & Verificatore & 2013-04-17\\
2.3 & Rivista descrizione CS01 e CS07. Aggiunta componente CS08 & Andrea Meneghinello & Verificatore & 2013-04-16\\
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{class_gestione_database}
...
\begin{description}
  ...
  \item{\scshape\bfseries CS01 -- Gestione database}\\
In tale componente la classe \texttt{dao.util.ModifyUtil} implementa il pattern \texttt{template method} definendo un metodo per l'esecuzione di un'operazione su \texttt{dao.DataPersistenceManager}, e lasciando l'implementazione dell'algoritmo alle classi figlie. Tali sono: \texttt{dao.util.InsertUtil}, \texttt{dao.util.UpdateUtil} e \texttt{dao.util.DeleteUtil}.
