...
Quando un utente avvia la procedura di autenticazione la \inglese{servlet} che espone le funzionalità di questo componente, \texttt{authentication.LoginManager} (che estende a sua volta \texttt{javax.servlet.http.HttpServlet}), crea il contesto di autenticazione istanziando
