...
A titolo esemplificativo si riporta nel diagramma la relazione d'uso che intercorre tra \texttt{AddContactController} e \texttt{DataPersistanceManager}. Tale dipendenza è caratteristica di ogni classe \inglese{controller}. Qui vengono omesse al fine di rendere il diagramma più chiaro e comprensibile.
