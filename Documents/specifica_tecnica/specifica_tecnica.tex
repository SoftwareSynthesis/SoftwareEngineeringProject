...
\newcommand{\docAuthors}{Andrea Meneghinello\\& Diego Beraldin \\&Elena Zecchinato}
% Approvato da
...
\inglese{Presenter} incaricato di gestire la vista principale che contiene i metodi necessari alla visualizzazione delle viste di secondo livello nonché i controlli che ne attivano la comparsa o scomparsa in risposta all'interazioni con l'utente.
	\item{\scshape\bfseries Componenti che ne fanno uso:}
	\begin{itemize}[noitemsep,nolistsep]
	  \item[-] \textsf{CP03 -- Gestione GUI}
	  \item[-] \textsf{CV01 -- GUI}
