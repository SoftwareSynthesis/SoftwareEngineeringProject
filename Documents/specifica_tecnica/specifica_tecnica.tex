...
\begin{description}
  \item{\scshape\bfseries Descrizione}\\
Tramite questo pannello è possibile visionare i gruppi che compongono la rubrica dell'utente. i gruppi vengono rappresentanti mediante il loro nome all'interno di una lista. Affianco ad ogni nome comparirà un icona atta ad indicare la possibilità di eliminare il gruppo selezionato.
