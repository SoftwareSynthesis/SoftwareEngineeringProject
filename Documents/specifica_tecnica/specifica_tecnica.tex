...
Servlet il cui compito consiste nell'aggiungere alla rubrica personale dell'utente un nuovo contatto tra quelli registrati al sistema \caName.
	...
	\item{\scshape\bfseries Componenti che ne fanno uso:}
	\begin{itemize}[noitemsep,nolistsep]
	  \item[-] \textsf{CS03 -- Gestione rubrica} %TODO INSERIRE/VERIFICARE COMPONENTI CHE LA IMPLEMENTANO
	\end{itemize}
\end{description}
...
\begin{description}
	...
	\item{\scshape\bfseries Componenti che ne fanno uso}
		\begin{itemize}[noitemsep],nolistsep]
			\item[-] \textsf{CS04 -- Gestione autenticazione}
    			\item[-] \textsf{CS07 -- Façade del server} %TODO INSERIRE/VERIFICARE COMPONENTI CHE NE FANNO USO
		\end{itemize}
\end{description}
