...
In particolare \texttt{connection.ConnectionManager} è coinvolto in fase di \inglese{login} e collabora con \textsf{Gestione rubrica} e \textsf{Gestione database} per controllare la validità dell'autenticazione, quindi interagisce con \textsf{Gestione connessione} per creare un canale di comunicazione fra il server e il client, secondo le modalità illustrate nella sezione \ref{sec:gestioneconnessione}.
