...
\begin{description}
	\item{\scshape\bfseries UserData - Calls}: tale associazione si è risolta trasformando: il campo ID\_chiamante in un ForeignKey verso UserData (per collegare la chiamata a colui che l'ha avviata), e analogamente usando il campo ID\_ricevente come ForeingKey verso UserData (per collegare la chiamata a chi l'ha ricevuta).
