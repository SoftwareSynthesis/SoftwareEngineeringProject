...
\begin{description}
  \item{\scshape\bfseries Descrizione}\\
Tale vista viene tilizzata per rappresentare il profilo di un utente. Solo accedendo quest'ultima sarà possibile avviare una comunicazione con l'utente. Il contatto viene visualizzato selezionando l'utente dalla rubrica oppure tra i risultati di una ricerca.
