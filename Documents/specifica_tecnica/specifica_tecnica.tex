...
\begin{itemize}[noitemsep,nolistsep]
	...
	\item[-] \textsf{CS04 -- Façade del server};
...
\subsubsection{CS04 -- Façade del server}\label{sec:serverfacade}
\begin{description}
	\item{\scshape\bfseries Descrizione:}\\
...
\midrule
CS02 -- Gestione connessione & servlet.ConnectionManager servlet.StateManager\\
...
La scelta di porre tale classe nella componente \textsf{Gestione connessione} deriva dalla stretta relazione che intercorre tra la possibilità di chiamare un utente e lo stato in cui si trova quest'ultimo.
...
\subsubsection{Componenti che lo implementano}
\begin{description}
  \item{\scshape\bfseries CS04 -- Façade del server}\\
