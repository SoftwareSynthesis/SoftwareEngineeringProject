...
Per la produzione di diagrammi UML si adotterà il software ConceptDraw. Questo scelta perchè il \inglese{tool} si presenta molto semplice da usare, è molto potente e permette la creazione di moltissimi diagrammi UML adottando lo standard 2.0. La qualità dei diagrammi prodotti inoltre è molto buona.
...
\subsection{Avanzamento versione}
