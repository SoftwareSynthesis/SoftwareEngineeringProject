...
\item vantaggi derivati: si darà un elenco dei vantaggi apportati dall'utilizzo del \inglese{pattern}, in particolare sotto il profilo della manutenzione e del riuso del codice.;
\item Componenti che lo implementano: infine verranno elencati i componenti dell'architettura di sistema, che implementano il \inglese{pattern} descritto.
\end{itemize}
