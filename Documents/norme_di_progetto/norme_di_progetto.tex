...
\begin{itemize}
	...
	\item per ogni metodo, oltre ai tag già descritti e inseriti in una classe, dovrà contenere il tag \textit{@throws} per ogni tipologia di eccezione che può sollevare e un tag \textit{@param} per ogni parametro del metodo.
\end{itemize}
