...
\begin{itemize}
 ...
 \item gli strumenti per sviluppatori integrati in \textbf{Google \underline{Chrome}} (\url{https://developers.google.com/chrome-developer-tools}) e, in particolare:
  ...
  \item \textbf{JSCoverage}, un \inglese{tool} per la misurazione del \inglese{Code Coverage} di programmi \inglese{JavaScript}. Per testare il codice prima di eseguirlo sul \inglese{browser} aggiunge istruzioni di analisi di copertura al codice stesso.  
