...
\subsection{\underline{Repository}}
...
\newpage
\section{\underline{Milestones} e \underline{Ticketing}}
...
\subsection{\underline{Milestones}}
...
\subsubsection{Creazione nuova \underline{Milestone}}
...
\caption{Creazione di una nuova \underline{Milestone}} \label{fig:creazione_milestone}
\end{figure}
...
\subsubsection{Modifica \underline{Milestone}}
...
\caption{Modifica di una \underline{Milestone}} \label{fig:modifica_milestone}
\end{figure}
...
\subsection{\underline{Ticketing}}
Un \underline{ticket} rappresenta un compito da svolgere.

\subsubsection{Creazione nuovo \underline{Ticket}}
...
\caption{Creazione di un nuovo \underline{Ticket}} \label{fig:creazione_ticket}
\end{figure}
...
\subsubsection{Modifica \underline{Ticket}}
...
\caption{Modifica di un \underline{ticket}} \label{fig:modifica_ticket}
\end{figure}

\subsubsection{Ciclo di vita di un \underline{Ticket}}
