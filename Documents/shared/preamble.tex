...
Al fine di evitare incomprensioni dovute all'uso di termini tecnici nei documenti, viene redatto e allegato il documento \textit{glossario.2.0.pdf} dove vengono definiti e descritti tutti i termini marcati con una sottolineatura.%
}
...
\usepackage[table]{xcolor}                                % tabelle con righe colorate e alternate
