...
Sono previste 2 \underline{iterazioni}, al termine della prima sarà possibile avere il primo \underline{prototipo} per testare le funzioni di MyTalk, in data 2013-02-22.
...
\begin{description}
	...
	\item{\scshape\bfseries Riscontro effettivo:} i requisiti espressi non sono mutati in modo significavo durante le attività fin'ora svolte, le modifiche imposte in RR e RA non hanno portato variazioni così rilevanti da richiedere ulteriori sforzi non preventivati. Possiamo pertanto ritenere il rischio controllato nelle attività fin'ora svolte.
\end{description}
...
\begin{description}
	...
	\item{\scshape\bfseries Riscontro effettivo:} nonostante WebRTC subisca aggiornamenti minori regolarmente, tali cambiamenti non si sono rivelati particolarmente critici al punto di minare la fattibilità analizzata del progetto. Possiamo pertanto affermare che tale rischio risulta non ancora verificato.
\end{description}
...
\begin{description}
	...
	\item{\scshape\bfseries Riscontro effettivo:} sono state effettuate delle modifiche più o meno significative alle ore assegnate ai componenti nell'esecuzione delle varie attività, non sono state necessarie riassegnazioni di risorse assegnate ad altri compiti; il rischio risulta pertanto attualmente gestito.
\end{description}
...
A livello hardware non si sono riscontrati problemi negli strumenti in dotazione del gruppo. Il rischio pertanto risulta attualmente gestito correttamente.
\end{description}
