...
Questa attività inizia in data 2013-01-09 e finisce in data 2013-01-31, per un totale di 20 giorni lavorativi. \\
...
Questa attività inizia in data 2012-03-05 e finisce in data 2012-03-22, per un totale di 16 giorni \underline{lavorativi}. Coinvolge i ruoli di Responsabile, Amministratore, Progettista, Programmatore e Verificatore. Si può notare che non è più attivo quindi il ruolo di Analista, si prevede infatti che a questo stadio del progetto l’attività di analisi sia ovviamente conclusa.
...
\hline
\end{tabular}
\caption{copertura ruoli nell'attività di Verifica e Validazione}\label{tab:ruolivv}
\end{table}
\clearpage
...
\caption{Torta ripartizione ruoli nell'attività di Verifica e Validazione}\label{fig:ruolivv}
\end{figure}
\\\\
...
\hline
\end{tabular}
\caption{copertura ruoli nell'attività di Verifica e Validazione}\label{tab:ruolivv2}
\end{table}
...
\hline
\end{tabular}
\caption{ruoli per persona nell'attività di verifica e validazione}\label{tab:ruolivv3}
\end{table}
