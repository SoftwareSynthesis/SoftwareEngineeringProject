...
% Nome file
\newcommand{\docFileName}{piano\_di\_progetto.4.0.pdf}
% Versione
\newcommand{\docVers}{4.0}
% Data creazione
\newcommand{\creationDate}{2012-12-03}
% Data ultima modifica
\newcommand{\modificationDate}{2012-05-15}
...
4.0 & Approvazione documento & Marco Schivo & Responsabile & 2013-05-15\\
3.4 & Aggiunta sezione del consuntivo relativa alla Validazione& Marco Schivo & Responsabile & 2013-05-14\\
3.3 & Correzione errore su tabella in consuntivo PA con conseguente errore nella somma del consuntivo finale& Marco Schivo & Responsabile & 2013-05-13\\
3.2 & Correzione errori sulle date e costi segnalati in sede di RQ& Marco Schivo & Responsabile & 2013-05-13\\
3.1 & Aggiornata sezione ``Analisi dei rischi'' con rischi non pianificati e consunto finale sugli stessi & Marco Schivo & Responsabile & 2013-05-13\\
3.0 & Approvazione documento & Andrea Rizzi & Responsabile & 2013-03-25\\
...
2.0 & Approvazione documento & Riccardo Tresoldi & Responsabile & 2013-01-30\\
1.7 & Correzione errori lessico ortografici del documento riscontrati & Riccardo Tresoldi & Responsabile & 2013-01-29\\
1.6 & Inserimento diagramma Gantt di figura 10 e tabelle 17 e 18 relative alla sezione 7.1 & Riccardo Tresoldi & Responsabile & 2013-01-28\\
1.5 & Completa stesura sezione 7.1 & Riccardo Tresoldi & Responsabile & 2013-01-26\\
1.4 & Creazione e stesura preliminare del capitolo ``Consuntivo'' con la sezione relativa alla Progettazione Architetturale & Andrea Meneghinello & Responsabile & 2013-01-25\\
1.3 & Correzione ed integrazione della tabella 15 relativa al prospetto orario & Andrea Meneghinello & Responsabile & 2013-01-15\\
1.2 & Specifica dei documenti da consegnare in RP e RQ e modifica titolo relativo ala sezione ``Validazione'' & Andrea Meneghinello & Responsabile & 2013-01-15\\
1.1 & Correzione errori a livello ortografico e di terminologia riscontrati in fase di RR & Andrea Meneghinello & Responsabile & 2013-01-14\\
...
Dalle tabelle \ref{tab:consoreprog} e \ref{tab:concostisprog} riportate a pagina \vref{tab:concostisprog} si denota il risparmio di tempo e denaro stimato in 9 ore lavorative e per un totale di \EUR{135}. Tali risorse verranno reimpiegate nelle attività successive alla Progettazione Architetturale qualora se ne manifestasse la necessità.
...
Dato lo spostamento temporale della consegna del prodotto finale dovuto principalmente alla revisione della progettazione architetturale e ad imprevisti durante la progettazione di dettaglio e la codifica, il team ha valutato di delegare ulteriori risorse all'attività di programmazione e alla verifica per rifinire nel modo migliore il prodotto, integrando funzionalità aggiuntive che inizialmente non erano state candidate ad implementabili durante i \inglese{brainstorming} interni in modo da sfruttare al massimo (ma rimanendo sostanzialmente in linea con gli investimenti preventivati) il periodo disponibile precedente alla data di collaudo. \\
...
\begin{figure}[h]
 \includegraphics[width=\textwidth]{Consuntivo_Val}
...
Stefano Farronato & & & & & \textcolor{green}{2}& 18\\
...
Le tabelle \ref{tab:consoreval} e \ref{tab:conscostival} aggiornano il consumo di risorse temporali ed economiche. Si può notare un discostamento da quanto preventivato di 14 ore lavorative in eccesso e \EUR{124} da sommare a consuntivo, e sottraendo i \EUR{10} risparmiati dalle precedenti attività si calcola un totale di \EUR{114}. Tale deficit è da considerarsi come un investimento extra e pertanto non è imposto al committente ma totalmente assorbito dal team.
...
Di seguito vengono riportate le tabelle relative rispettivamente alle ore svolte da ogni componente del team e per ogni risorsa impiegata nello svolgimento del progetto \caName, specificando le stesse nelle tre attività progettuali (progettazione architetturale, progettazione di dettaglio e codifica, validazione).

\begin{table}[H]
\centering
\begin{tabular}{|l|c|c|c|c|c|}
\hline
Ruolo&Consuntivo PA&Consuntivo PDC&Consuntivo V&Preventivato& Finale \\
\hline
...
\hline
Orario & 721& 735\\
Economico & \EUR{13.211,00} &\EUR{13.325,00}\\
\hline
\end{tabular}
...
\begin{description}
	\item{\scshape\bfseries Analisi:} l'inesperienza del team nello svolgere attività di pianificazione, può portare ad un'errata stima dei costi preventivati. Il rischio è quello di sforare nei costi e di effettuare ore lavorative extra. 
	\item{\scshape\bfseries Probabilità:} MEDIA
...
\subsection{Strumenti non idonei}
\begin{description}
...
\subsection{Errato approccio o esito di una revisione}
\begin{description}
