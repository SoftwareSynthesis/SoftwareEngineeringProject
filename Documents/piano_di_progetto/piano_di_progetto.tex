...
In base a quanto riscontrato durante l'ultima attività progettuale, il team può ora avere un quadro completo sulle problematiche e le risorse effettivamente richieste da un progetto di tali dimensioni. La differenza tra quanto preventivato economicamente e temporalmente risultano essere stimate in un X\% e Y\% rispettivamente rispetto a quanto effettivamente riscontrato. Tale dati denotano una pianificazione progettuale tutto sommato di buona qualità viste le premesse a livello di esperienza da parte dei membri del team, portando a risultati soddisfacenti con investimenti in prevedibili e preventivati.\\
