...
Nella seconda vengono descritte invece le varie funzioni che \caName offre: le modalità di comunicazione con gli altri utenti, l'interazione con la rubrica personale,la gestione del proprio \underline{\inglese{account}} e della lingua dell'interfaccia, l'utilizzo della segreteria e la visualizzazione dello storico delle chiamate.
...
L'applicazione non necessita di installazione, è sufficiente aprire il browser, digitare nella \underline{barra relativa all'inserimento dell'\inglese{url}} e digitare
\begin{center}
...
Una volta inseriti i dati richiesti e premuto il pulsante \texttt{registrati} la registrazione sarà avvenuta e verrà visualizzato il relativo messaggio di conferma.
...
\item\textbf{Barra relativa all'inserimento dell'\inglese{url}:} barra destinata all'inserimento dell'indirizzo identificativo di ogni sito web, riuscendo così a raggiungerlo e visualizzarlo. È generalmente posizionata nella parte superiore del browser.
