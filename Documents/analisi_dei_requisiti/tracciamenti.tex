...
PREAMBOLO\subsection{Requisiti obbligatori}
...
RUFO4.0.0 & L'utente dovrebbe poter tenere tenere una rubrica personale dove raggruppare i propri contatti. & Interno \\
...
RSFF11.2.0 & Utilizzo del protocollo webSocket per creare una connessione tra piu di 2 utenti & Interno \\
...
RUFF15.0.0 & L'utente avrà a disposizine una segreteria telefonica & Interno \\
...
RUFF20.3.0 & Condivione lavagna grafica & Interno \\
...
RSDD2.1.0 & L'utente dovrebbe avere una stima della complessità per la proipria password. & Capitolato d'appalto \\
...
\bottomrule
\end{longtable}
\section{Tracciamento dei requisiti}\label{sec:tracciamento}
