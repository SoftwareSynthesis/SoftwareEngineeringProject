...
\caption{Schermata login, registrazione e recupero password}\label{fig:home_iniziale}
\end{center}
\end{figure}
\begin{description}
...
\caption{Schermata login}\label{fig:login}
\end{center}
\end{figure}
\begin{description}
\item{\scshape\bfseries Attori principali:}Utente.
...
\caption{Schermata registrazione}\label{fig:registrazione}
\end{center}
\end{figure}
\begin{description}
\item{\scshape\bfseries Attori principali:}Utente.
...
\caption{Schermata recupero password}\label{fig:recupero_password}
\end{center}
\end{figure}
\begin{description}
\item{\scshape\bfseries Attori principali:}Utente.
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=.9\textwidth]{UC2}
\caption{Home Screen}\label{fig:home_screen}
\end{center}
\end{figure}
\begin{description}
...
\caption{Operazioni disponibili per gestione accout}\label{fig:modifica_account}
\end{center}
\end{figure}
\begin{description}
\item{\scshape\bfseries Attori principali:}Utente autenticato.
...
\caption{Operazioni disponibili per gestione stato}\label{fig:gestione_stato}
\end{center}
\end{figure}
\begin{description}
\item{\scshape\bfseries Attori principali:}Utente autenticato.
...
\caption{Operazioni disponibili per gestione rubrica}\label{fig:gestione_rubrica}
\end{center}
\end{figure}
\begin{description}
\item{\scshape\bfseries Attori principali:}Utente autenticato.
...
\caption{Operazioni disponibili per gestione segretaria telefonica}\label{fig:gestione_segretaria}
\end{center}
\end{figure}
\begin{description}
\item{\scshape\bfseries Attori principali:}Utente autenticato.
...
\caption{Operazioni disponibili durante una connessione con un utente}\label{fig:connessione}
\end{center}
\end{figure}
\begin{description}
\item{\scshape\bfseries Attori principali:}Utente autenticato.
...
\caption{Visualizzazione statistiche della comunicazione}\label{fig:statistiche}
\end{center}
\end{figure}
\begin{description}
\item{\scshape\bfseries Attori principali:}Utente autenticato.
...
\caption{Schermata ricerca utente}\label{fig:ricerca}
\end{center}
\end{figure}
\begin{description}
\item{\scshape\bfseries Attori principali:}Utente autenticato.
