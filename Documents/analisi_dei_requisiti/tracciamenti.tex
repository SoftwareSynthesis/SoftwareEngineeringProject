...
\begin{center}
\includegraphics[width=.45\textwidth]{UC1}
\end{center}
\begin{description}
...
\item{\scshape\bfseries Precondizione:} L'utente e' autenticato al sistema; la lista degli utenti registrati presso il \underline{server} non è vuota.
...
RSFO11.0.0 & Creare una connessione tra \underline{client}, mediante l'utilizzo di un \underline{server} & Capitolato d'appalto \\
RSFO11.1.0 & Utilizzo del protocollo \underline{webSocket} per creare una connessione tra 2 utenti & Interno \\
...
RSDO22.0.0 & L'applicativo deve funzionare sotto l'ultima versione (23.0.1271.97m) del \underline{browser} Google \underline{Chrome} & Capitolato d'appalto \\
\bottomrule
\end{longtable}
...
RSFF11.2.0 & Utilizzo del protocollo \underline{webSocket} per creare una connessione tra più di 2 utenti & Interno \\
RSFF12.1.0 & Estendere la connessione ad altri \underline{client} & Interno \\
...
RSQF23.0.0 & Verificare che l'applicativo funzioni anche sotto gli altri \underline{browser} del S.O. Windows & Interno \\
...
RSQF24.0.0 & Verificare che l'applicativo funzioni anche sotto gli altri \underline{browser} del S.O. Linux & Interno \\
...
RSQF25.0.0 & Verificare che l'applicativo funzioni anche sotto gli altri \underline{browser} del S.O. Macintosh & Interno \\
