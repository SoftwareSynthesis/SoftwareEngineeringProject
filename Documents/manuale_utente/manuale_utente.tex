...
Nella parte inferiore del pannello centrale sono presenti i pulsanti d'interazione con la chiamata: \texttt{termina chiamata}, \texttt{dati chiamata} e, ...\\ %TODO: da completare
...
\begin{figure}[H]
  \includegraphics[width=\textwidth]{manual_groups}
