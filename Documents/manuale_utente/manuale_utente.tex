...
\begin{itemize}[noitemsep,nolistsep]
  \item[-] il \inglese{\inglese{browser}} utilizzato, la versione dello stesso e il sistema operativo;
...
proprio \inglese{account}, con la possibilità di effettuare eventuali modifiche ai campi dati.
