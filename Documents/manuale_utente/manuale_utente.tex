...
% Data creazione
\newcommand{\creationDate}{2013-03-22}
...
\newcommand{\docAuthors}{Elena Zecchinato\\ & Stefano Farronato}
% Approvato da
...
%TODO: cambiare immagine registrazione con elementi obbligatori/facoltativi.
...
\item \textcolor{green}{\textbf{Area laterale destra:}} area dedicata ai servizi a disposizione dell'utente. È possibile accedere a tutte le funzionalità collegate alla gestione del proprio account che verranno successivamente espanse nell'area centrale descritta precedentemente:
\begin{description}
...
proprio account, con la possibilità di effettuare eventuali modifiche ai campi dati.
...
\item \textbf{Gruppi}: vengono creati/eliminati tramite la \inglese{form} associata i gruppi in cui vengono catalogati i contatti presenti nella rubrica.
\end{description}
\item \textcolor{red}{\textbf{Area laterale sinistra}} area dedicata alla rubrica dell'utente.  
\end{description}
...
%TODO: descrivere schermata chiamata audio (pulsanti-statistiche-ecc...)
...
%TODO: descrivere schermata chiamata audio-video (pulsanti-statistiche-ecc...)
...
%TODO: descrivere schermata chat testuale (pulsanti-ecc...)
