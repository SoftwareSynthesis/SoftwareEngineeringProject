...
\glossaryItem{\inglese{Brainstorming}}{%
parola inglese che tradotta in italiano significa letteralmente ``tempesta di cervelli'', sta ad indicare una riunione, solitamente con un discreto numero di persone, nella quale viene effettuata una 
}
