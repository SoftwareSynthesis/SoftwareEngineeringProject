...
\letterbox{t}
\glossaryItem{TCO}{%
acronimo di \inglese{Total Cost of Ownership}, è un approccio di gestione dei costi per apparecchiatura informatica (\inglese{Software} e \inglese{Hardware}) che tiene cosnto delle varie fasi: acquisto, installazione, gestione, manutenzione e smantellamento.
}
