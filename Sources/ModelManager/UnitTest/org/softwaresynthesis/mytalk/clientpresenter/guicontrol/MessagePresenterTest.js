...
// TODO: DA AGGIUSTARE
/*
 * test("testList()", function(){ var i=0; tester.displayList(); var list =
 * document.getElementById("MessageList"); equal(list.childNodes.length, 1,
 * "numero corretto di nodi"); i++; expect(i); });
 * 
 * test("testDelete()", function() { var i=0; var message= {}; message.id=1;
 * test.deleteMessage(message); var list =
 * document.getElementById("MessageList"); equal(list.childNodes.length, 1,
 * "numero corretto di nodi"); i++; expect(i); });
 */