...
function AddressBookPanelPresenter() {
	...
	function getServletURLs() {
		...
		var names = Array();
		names
				.push(XMLDocument.getElementById("getcontacts").childNodes[0].data);
		;
		names.push(XMLDocument.getElementById("addcontact").childNodes[0].data);
		names
				.push(XMLDocument.getElementById("deletecontact").childNodes[0].data);
		...
		names
				.push(XMLDocument.getElementById("creategroup").childNodes[0].data);
		names
				.push(XMLDocument.getElementById("deletegroup").childNodes[0].data);
	...
	this.addGroup = function(name) {
		// TODO può avere senso fare una funzione per controllare che il nome
		// non
	 ...
	 * @param {Array}
	 *            filtredContacts Array di contrati
	 */
